...
const AgendaTugas = () => {
  return (
    <div className="p-6">
      <h2 className="text-xl font-bold text-gray-800 mb-4">Checklist Publikasi</h2>
      <div className="bg-white p-4 rounded shadow-sm border flex items-center gap-3">
         ...
         <span className="font-medium text-gray-800">Blast Email Reminder H-1 ke Peserta</span>
      </div>
    </div>
  );
};
